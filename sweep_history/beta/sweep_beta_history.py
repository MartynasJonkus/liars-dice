...
def run_single_game(args):
    ...
    agent_specs = [
        (agent_paths[0], {"hist_beta": value}),   # ISMCTS tuned
...
def run_c_sweep_parallel(
    ...
    for v in values:
        print(f"\n=== Running sweep for beta = {v} ({num_games} games) ===")
    ...
    plt.title("ISMCTS-History Average placement vs constant beta")
    plt.xlabel("Constant beta")
