...
def play_one_game_c_sweep(agent_paths: List[str], c_value: float, dice_per_player: int, seed: int):
    ...
    placement = placements.index("ISMCTS-Heuristic") + 1
    return placement
...
def run_c_sweep(
    ...
    plt.title("ISMCTS-Heuristic placement distribution vs exploration constant C")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sweep UCT c values for ISMCTS-Heuristic")
